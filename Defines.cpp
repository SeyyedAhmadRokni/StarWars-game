...
const int STANDARD_BLOCK_WIDTH = 10;
const int STANDARD_BLOCK_HEIGHT = 10;
const int STANDARD_SEPRATOR_WIDTH = 2;
const int STANDARD_SEPRATOR_HEIGHT = 2;

const int PLAYER_MOVE_RATE = 7;
